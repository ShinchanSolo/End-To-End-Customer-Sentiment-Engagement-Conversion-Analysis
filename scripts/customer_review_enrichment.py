...
def fetch_data_from_sql():
    ...
    query = "SELECT review_id, customer_id, product_id, review_date, rating, review_text FROM gold.fact_customer_reviews"
...
customer_reviews_df['sentiment_score'] = customer_reviews_df['review_text'].apply(calculate_sentiment)
