...
# installed.
TCL_PREFIX='D:/marketing_360_analysis/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/marketing_360_analysis/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/marketing_360_analysis/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/marketing_360_analysis/venv\Library\include'
...
TCL_PACKAGE_PATH='D:/marketing_360_analysis/venv\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/marketing_360_analysis/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/marketing_360_analysis/venv\Library\lib\tclstub86.lib'
